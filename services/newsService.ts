...
export const fetchCanoeNews = async (): Promise<{ news: NewsItem[], events: CompetitionEvent[] }> => {
  ...
  const prompt = `
    Aja como um especialista em esportes de remo. Busque as últimas notícias e calendários de competições de 2024 e 2025 sobre:
    ...
    Use o Google Search para garantir que as informações são recentes.
  `;
